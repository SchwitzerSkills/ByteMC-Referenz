...
public class ScoreAPI {
    ...
    public static void setScoreboard(Player p){
        ...
        for(Player on : Bukkit.getOnlinePlayers()){
            if(on.hasPermission("KnockIT.Owner")){
                owner.addPlayer(on);
            } else if(on.hasPermission("KnockIT.Admin")){
                admin.addPlayer(on);
            } else if(on.hasPermission("KnockIT.TeamLeitung")){
                teamleitung.addPlayer(on);
            } else if(on.hasPermission("KnockIT.Developer")){
                dev.addPlayer(on);
            } else if(on.hasPermission("KnockIT.Moderator")){
                mod.addPlayer(on);
            } else if(on.hasPermission("KnockIT.Builder")){
                builder.addPlayer(on);
            } else if(on.hasPermission("KnockIT.Supporter")){
                sup.addPlayer(on);
            } else if(on.hasPermission("KnockIT.TDeveloper")){
                tdev.addPlayer(on);
            } else if(on.hasPermission("KnockIT.TSupporter")){
                tsup.addPlayer(on);
            } else if(on.hasPermission("KnockIT.TBuilder")){
                tbuilder.addPlayer(on);
            } else if(on.hasPermission("KnockIT.Youtuber")){
                youtuber.addPlayer(on);
            } else if(on.hasPermission("KnockIT.Premium+")){
                premiump.addPlayer(on);
            } else if(on.hasPermission("KnockIT.Friend")){
                friend.addPlayer(on);
            } else if(on.hasPermission("KnockIT.Griefer")){
                griefer.addPlayer(on);
            } else if(on.hasPermission("KnockIT.Titan")){
                titan.addPlayer(on);
            } else if(on.hasPermission("KnockIT.Legend")){
                legend.addPlayer(on);
            } else if(on.hasPermission("KnockIT.Ultra")){
                ultra.addPlayer(on);
            } else if(on.hasPermission("KnockIT.Premium")){
